...
export default function HeaderLanguages() {
  ...
  return (
    <Col className="hp-languages hp-mr-12">
      <div className="hp-d-flex-center hp-cursor-pointer">
        <Avatar size={18} src={require(`../../../assets/images/languages/${activeLanguage}.svg`)} />
      </div>
                ...
                item !== activeLanguage && (
                  <Menu.Item key={index} onClick={() => dispatch(switchLanguage(item))}>
                    <div className="hp-d-flex-center">
                      <Avatar size={24} src={require(`../../../assets/images/languages/${item}.svg`)} />
